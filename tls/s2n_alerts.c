...
static S2N_RESULT s2n_translate_protocol_error_to_alert(int error_code, uint8_t *alert)
{
    ...
    switch(error_code) {
        ...
        S2N_NO_ALERT(S2N_ERR_CRL_LOOKUP_REJECTED);
        S2N_NO_ALERT(S2N_ERR_CRL_NOT_FOUND);
        S2N_NO_ALERT(S2N_ERR_CRL_SIGNATURE);
        S2N_NO_ALERT(S2N_ERR_CRL_THIS_UPDATE_FIELD);
        S2N_NO_ALERT(S2N_ERR_CRL_NEXT_UPDATE_FIELD);
