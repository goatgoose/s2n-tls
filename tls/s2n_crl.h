...
int s2n_crl_lookup_get_cert_issuer_hash(struct s2n_crl_lookup_context *context, unsigned long *hash);
...
S2N_RESULT s2n_crl_lookup(struct s2n_connection *conn, struct s2n_x509_validator *validator);
