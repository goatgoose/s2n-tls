...
int main(int argc, char **argv)
{
    ...
    EXPECT_SUCCESS(s2n_hmac_wipe(&conn->secure->client_record_mac));
    EXPECT_SUCCESS(s2n_hmac_set_implementation(&conn->secure->client_record_mac, S2N_HMAC_CUSTOM_IMPL));
