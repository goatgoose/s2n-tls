 ...
 *
 * This API is intended to be used with certificates created with `s2n_minimal_config_new`, which
 ...
 * into the trust store, which includes all configs created with `s2n_config_new`.
